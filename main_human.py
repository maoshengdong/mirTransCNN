...
from precessor import import_data, import_test_data
...
def Main():
  # train
  pos_file = "data/human/train/pos/X_train_pos.csv"
  neg_file = "data/human/train/neg/X_train_neg.csv"
  signal = 'train_human'
  x_train_dataset, y_train_dataset, feature_train_dataset, bn_size = import_data(pos_file, neg_file, MAX_LEN, DIM_ENC,signal)
  ...
  # validation
  pos_file = "data/human/test/pos/X_test_pos.csv"
  neg_file = "data/human/test/neg/X_test_neg.csv"
  x_test_dataset, y_test_dataset, feature_test_dataset = \
    import_test_data(pos_file, neg_file, MAX_LEN, DIM_ENC, signal)
  flag = "test"
