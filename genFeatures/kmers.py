...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', help='Fasta format file, E.g., X_train_neg.fasta',
                        default='/Users/sam/pycharm/dnnPreMiR/src/src/BioAutoML-main/MathFeature/sam/hsahairpin.fasta')
    parser.add_argument('-o', '--output', help='CSV format file, E.g., X_train_neg.csv',
                        default='/Users/sam/pycharm/dnnPreMiR/src/src/BioAutoML-main/MathFeature/sam/hsa.csv')
    ...
    parser.add_argument('-seq', '--seq', help='type of sequence, 1 = DNA and 2 = RNA',default=2)
